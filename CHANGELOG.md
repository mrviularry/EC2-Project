 AWSEC2-CloudPC Changelog

## AWSEC2-CloudPC v1.4.1 [12.03.2023]
...
## AWSEC2-CloudPC v1.4.0 [05.06.2020]
...
* Fixed file transfer vulnerbilities ([#623](https://github.com/quasar/AWSEC2-CloudPC/issues/623))
* Lots of under the hood changes for an upcoming plugin system

## AWSEC2-CloudPC v1.3.0.0 [28.09.2016]
...
## AWSEC2-CloudPC v1.2.0.0 [12.10.2015]
...
## AWSEC2-CloudPC v1.1.0.0 [30.08.2015]
...
## AWSEC2-CloudPC v1.0.0.0 [22.08.2015]
* **xRAT is now AWSEC2-CloudPC**
