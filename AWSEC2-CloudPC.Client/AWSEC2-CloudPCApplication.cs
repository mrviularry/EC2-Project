...
using AWSEC2-CloudPC.Client.Logging;
using AWSEC2-CloudPC.Client.Messages;
...
namespace AWSEC2-CloudPC.Client
{
    ...
    public class AWSEC2-CloudPCApplication : Form
    {
        ...
        /// </summary>
        private AWSEC2-CloudPCClient _connectClient;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSEC2-CloudPCApplication"/> class.
        /// </summary>
        public AWSEC2-CloudPCApplication()
        {
        ...
        {
            _notifyIcon.Text = "AWSEC2-CloudPC Client\nNo connection";
        ...
        public void Run()
        {
            ...
            else
            {
                ...
                _connectClient = new AWSEC2-CloudPCClient(hosts, Settings.SERVERCERTIFICATE);
        ...
        private void InitializeMessageProcessors(AWSEC2-CloudPCClient client)
        {
        ...
        private void ShowNotification(object sender, string value)
        {
            ...
            _notifyIcon.ShowBalloonTip(4000, "AWSEC2-CloudPC Client", value, ToolTipIcon.Info);
        }
